...
(function(){
  ...
  var SECTIONS = {
    panel:{ ic:'fa-gauge-high', eyebrow:'Genel Bakış', title:'Ana Panel', menu:[
      ...
      {seclbl:'Gündem'},
      {ic:'fa-sun',            lbl:'Günlük Özet',      wip:1},
      {ic:'fa-list-check',     lbl:'Görevlerim',       wip:1},
      {ic:'fa-stamp',          lbl:'Bekleyen Onaylar', wip:1, cnt:'12'},
      {ic:'fa-bell',           lbl:'Bildirimler',      wip:1}
    ]},
    ...
    ayarlar:{ ic:'fa-sliders', eyebrow:'Yönetim', title:'Ayarlar', menu:[
      ...
      {ic:'fa-users-gear',     lbl:'Kullanıcılar',     wip:1},
      {ic:'fa-user-shield',    lbl:'Roller & Yetkiler',wip:1},
      {ic:'fa-diagram-project',lbl:'Onay Akışları',    wip:1},
      {ic:'fa-puzzle-piece',   lbl:'Modüller',         wip:1}
    ]},
